...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWJpbmF5IiwiYSI6ImNsdzJ4Y3U3cjBzeDYyaW9jdnF1dTJvN2QifQ.x3K48dLyzVgBj-4vN6ip9g';
...
var logout = exports.logout = function logout() {
  _axios.default.get('/api/v1/users/logout').then(function (res) {
...
var signup = exports.signup = function signup(name, email, password, passwordConfirm) {
  console.log(name, email, password, passwordConfirm);
  _axios.default.post('/api/v1/users/signup', {
    name: name,
    email: email,
    password: password,
    ...
    if (res.data.status === 'success') {
      (0, _alert.showAlert)('success', 'Account Created successful');
      window.setTimeout(function () {
        location.assign('/');
      }, 1000);
    }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable */
var stripe = Stripe('pk_test_51PFtEzLSB7PSDpl8bKVvEcWck1pU9yCChIuAF4DmIFsIEW1XkzL2tD7YKqre0fZ5GfjTvl1BZ6vRoYf7N1ggsc7400fTndIUMI');
...
if (signForm) signForm.addEventListener('submit', function (el) {
  el.preventDefault();
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "57493" + '/');
